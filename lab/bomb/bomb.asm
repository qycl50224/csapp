...
0000000000400f43 <phase_3>:
  ...
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)       must < 0x7
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>   #-->bomb
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax  
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)    402470+8*(%rax)
...
0000000000400fce <func4>:
  400fce:	48 83 ec 08          	sub    $0x8,%rsp                     stack pointer
  400fd2:	89 d0                	mov    %edx,%eax                     result = 14
  400fd4:	29 f0                	sub    %esi,%eax                      result -= 
  400fd6:	89 c1                	mov    %eax,%ecx
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx          a = result  a >>>(Logical) 31
  400fdb:	01 c8                	add    %ecx,%eax                      result += a
  400fdd:	d1 f8                	sar    %eax                            result  >> 1
...
000000000040100c <phase_4>:
  ...
  401033:	76 05                	jbe    40103a <phase_4+0x2e>     must  <= 0xe
  401035:	e8 00 04 00 00       	callq  40143a <explode_bombx>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx       third param
  40103f:	be 00 00 00 00       	mov    $0x0,%esi       second param
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi  first param     
  401048:	e8 81 ff ff ff       	callq  400fce <func4>    call func4     must return 0
  40104d:	85 c0                	test   %eax,%eax                        %eax != 0 then bomb
  40104f:	75 07                	jne    401058 <phase_4+0x4c>
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)              0x0 == 0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51>     jump   
  401058:	e8 dd 03 00 00       	callq  40143a <explode_bomb>     bomb
  40105d:	48 83 c4 18          	add    $0x18,%rsp               stack pointer
  401061:	c3                   	retq   
...
0000000000401062 <phase_5>:
  ...
  401082:	74 4e                	je     4010d2 <phase_5+0x70> // length == 6 ->4010d2
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>    length != 6 bomb
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>    bomb and jump to end
...
00000000004015c4 <phase_defused>:
  ...
  401615:	75 1e                	jne    401635 <phase_defused+0x71>  eax != 0 then jump
