...
#define FTRP(bp) ((char 8)(bp) + GET_SIZE(HDRP(bp)) - DSIZE)
...
int mm_init(void)
{
	...
	PUT(headptr, 0);
	PUT(headptr+WSIZE, PACK(8, 1));
	PUT(headptr+2*WSIZE, PACK(8, 1));
...
static void *extend_heap(size_t words)
{
	...
	size = (words % 2)? (words+1)*WSIZE:wods*WSIZE;
